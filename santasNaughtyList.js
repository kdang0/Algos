 ...
 * @returns {Array<Person>} The people that have the given bad habit.
 */
 function santasNaughtyListFunctional(persons, badHabit,newArray=[]) {
    persons.forEach((current)=> {current.habits.includes(badHabit)?newArray.push(current.firstName+' '+current.lastName):null}); return newArray
}
